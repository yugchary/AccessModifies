...
public class DifferentPackageChildClass extends SamePackageBase {
	...
	public DifferentPackageChildClass() {
		super();
		System.out.println("DifferentPackageChildClass consturctor");
	}
